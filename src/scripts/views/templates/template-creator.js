...
const createRestaurantDetailTemplate = (restaurant) => `
      <picture>
        <source media="(max-width: 600px)" data-srcset="${CONFIG.BASE_IMAGE_URL + '/medium/' + restaurant.pictureId}">
          <img class="restaurant__poster lazyload" alt="${restaurant.name}" tabindex="0" data-src="${CONFIG.BASE_IMAGE_URL + '/large/' + restaurant.pictureId}">
      </picture>
                ...
                <a href="${`/#/detail/${restaurant.id}`}">
                    ...
                    <picture>
                      <source media="(max-width: 600px)" data-srcset="${CONFIG.BASE_IMAGE_URL + '/small/' + restaurant.pictureId}">
                        <img class="item_thumbnail lazyload" alt="${restaurant.name}" tabindex="0" data-src="${CONFIG.BASE_IMAGE_URL + '/small/' + restaurant.pictureId}">
                    </picture>
