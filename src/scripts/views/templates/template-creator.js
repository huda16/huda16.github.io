...
const createRestaurantDetailTemplate = (restaurant) => `
      <picture class="lazyload">
        <source media="(max-width: 600px)" srcset="${CONFIG.BASE_IMAGE_URL +'/medium/'+ restaurant.pictureId}">
          <img class="restaurant__poster lazyload" src="${CONFIG.BASE_IMAGE_URL +'/large/'+ restaurant.pictureId}" alt="${restaurant.name}" tabindex="0">
      </picture>
                ...
                <a href="${`/#/detail/${restaurant.id}`}">
                    ...
                    <picture class="lazyload">
                      <source media="(max-width: 600px)" srcset="${CONFIG.BASE_IMAGE_URL +'/small/'+ restaurant.pictureId}">
                        <img class="item_thumbnail lazyload" src="${CONFIG.BASE_IMAGE_URL +'/medium/'+ restaurant.pictureId}" alt="${restaurant.name}" tabindex="0">
                    </picture>
